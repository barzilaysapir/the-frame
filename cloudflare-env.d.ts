/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 9a01655a30919fac010c0c951ba43fcb)
// NOTE: COURSE_VIDEOS/VIDEO_SIGNING_SECRET/PREVIEW_CATALOG_TOKEN below were
// added by hand (no live Cloudflare account access in this session) to
// match the new r2_buckets binding in wrangler.jsonc + the `.dev.vars`
// VIDEO_SIGNING_SECRET/PREVIEW_CATALOG_TOKEN convention (see
// .dev.vars.example). Re-run `npm run cf-typegen` once a real `.dev.vars`
// exists locally to regenerate this file for real and confirm it matches.
// Runtime types generated with workerd@1.20260804.1 2026-08-04 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ADMIN_EMAILS: string;
	// TAKBULL_* added by hand, same convention — see .dev.vars.example
	// and lib/server/payments/takbull.ts. Re-run `npm run cf-typegen`
	// once a real value exists.
	TAKBULL_API_KEY: string;
	TAKBULL_API_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_FIREBASE_API_KEY" | "NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN" | "NEXT_PUBLIC_FIREBASE_PROJECT_ID" | "NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET" | "NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID" | "NEXT_PUBLIC_FIREBASE_APP_ID" | "NEXT_PUBLIC_SITE_URL">> {}
}
