...
// NOTE: COURSE_VIDEOS/VIDEO_SIGNING_SECRET below were added by hand (no live
// Cloudflare account access in this session) to match the new r2_buckets
// binding in wrangler.jsonc + the `.dev.vars` VIDEO_SIGNING_SECRET convention
// (see .dev.vars.example). Re-run `npm run cf-typegen` once a real
// `.dev.vars` exists locally to regenerate this file for real and confirm it
// matches.
