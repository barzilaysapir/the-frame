...
// NOTE: COURSE_VIDEOS/VIDEO_SIGNING_SECRET/PREVIEW_CATALOG_TOKEN/R2_* below
// were added by hand (no live Cloudflare account access in this session) to
// match the new r2_buckets binding in wrangler.jsonc + the `.dev.vars`
// VIDEO_SIGNING_SECRET/PREVIEW_CATALOG_TOKEN/R2_* convention (see
