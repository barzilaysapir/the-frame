 ...
 *
 * DO NOT EDIT THIS FILE — it has already been applied to local/remote D1.
 * Any further seed/pricing/copy fixes must ship as a new additive migration
 * (see migrations/0009_catalog_indexes.sql for the pattern), never by
 * rewriting an already-applied one. Verified in parity with the current
 * mock catalog via `npm run verify:mock-db-parity` (100 routines, 18
 * instructors, 2 locales) as of 2026-08-12.
 */
-- Styles
